...
export class OrganizationService {
  ...
  async getUserOrganizations(userId: string): Promise<Organization[]> {
    ...
    try {
      ...
      logger.warn('Failed to fetch organizations from Supabase:', error);
      return this.getLocalOrganizations(userId);
    }
  }
  ...
  async createOrganization(
    ...
    try {
      ...
      logger.warn('Failed to create organization in Supabase:', error);
      return this.saveLocalOrganization(newOrg, userId);
    }
  }
  ...
  async inviteMember(
    ...
    try {
      ...
      logger.warn('Failed to create invitation in Supabase:', error);
      this.saveLocalInvitation(invitation);
      return invitation;
    }
  }
  ...
  async getOrganizationMembers(organizationId: string): Promise<OrganizationMember[]> {
    ...
    try {
      ...
      logger.warn('Failed to fetch organization members:', error);
      return this.getLocalMembers(organizationId);
    }
  }
  ...
  async updateMemberRole(
    ...
    try {
      ...
      logger.warn('Failed to update member role in Supabase:', error);
      this.updateLocalMemberRole(organizationId, userId, newRole);
    }
  }
  ...
  private getLocalOrganizations(userId: string): Organization[] {
    try {
      ...
      logger.error('Failed to parse local organizations:', error);
    }
    return [];
  }
  ...
  private saveLocalOrganization(organization: Organization, userId: string): Organization {
    try {
      ...
      logger.error('Failed to save organization locally:', error);
      throw error;
    }
  }
  ...
  private saveLocalInvitation(invitation: Invitation): void {
    try {
      ...
      logger.error('Failed to save invitation locally:', error);
    }
  }
  ...
  private getLocalMembers(organizationId: string): OrganizationMember[] {
    try {
      ...
      logger.error('Failed to parse local members:', error);
    }
    return [];
  }
  ...
  private updateLocalMemberRole(organizationId: string, userId: string, newRole: string): void {
    try {
      ...
      logger.error('Failed to update member role locally:', error);
    }
  }
