...
class SupabaseApiService {
  ...
  async createAssessmentWorkflow(assessmentId: string, templateId?: string): Promise<any> {
    try {
      return await workflowApiService.createWorkflow(assessmentId, templateId);
    } catch (error) {
  ...
  async getAssessmentWorkflow(assessmentId: string): Promise<any> {
    try {
      return await workflowApiService.getWorkflowPhases(assessmentId);
    } catch (error) {
  ...
  async updateWorkflowPhase(phaseId: string, updates: any): Promise<any> {
    try {
      return await workflowApiService.updateWorkflowPhase(phaseId, updates);
    } catch (error) {
  ...
  async getWorkflowProgress(assessmentId: string): Promise<any> {
    try {
      return await workflowApiService.getWorkflowProgress(assessmentId);
    } catch (error) {
  ...
  async getWorkflowAnalytics(assessmentId: string): Promise<any> {
    try {
      return await workflowApiService.getWorkflowAnalytics(assessmentId);
    } catch (error) {
  ...
  async getTasksWithWorkflow(assessmentId: string): Promise<any> {
    try {
      return await workflowApiService.getTasksWithWorkflow(assessmentId);
    } catch (error) {
