...
export const DocumentPreviewModal: React.FC<DocumentPreviewModalProps> = ({
  ...
  const getFormatColor = (format: DocumentFormat) => {
    switch (format) {
      case 'md': return 'text-text-secondary-light';
      case 'docx': return 'text-primary-600';
      case 'pdf': return 'text-error-600';
      case 'xlsx': return 'text-success-600';
      default: return 'text-text-secondary-light';
    }
  };

  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-surface-light rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] flex flex-col">
        {/* Header */}
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-6 rounded-t-lg">
          <div className="flex justify-between items-center">
            <div>
              <h2 className="text-2xl font-bold">{templateName}</h2>
              <p className="text-primary-100 mt-1">Document Preview</p>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="flex-1 overflow-hidden flex">
          ...
          <div className="flex-1 p-6 overflow-y-auto">
            <div className="prose max-w-none">
              ...
              {templateData.description && <p className="text-text-secondary-light">{templateData.description}</p>}
              
              {templateData.controls && (
                <div className="bg-primary-50 border border-primary-200 rounded-lg p-4 mb-6">
                  <h3 className="font-semibold text-primary-800 mb-2">CMMC Controls Covered:</h3>
              ...
              {templateData.includes && (
                <div className="bg-success-50 border border-success-200 rounded-lg p-4 mb-6">
                  <h3 className="font-semibold text-success-800 mb-2">Document Includes:</h3>
                  <ul className="list-disc list-inside text-success-700">
              ...
              <div className="border-t pt-6">
                ...
                <div className="whitespace-pre-wrap text-sm text-text-primary-light">
                  {markdownContent}
                </div>
              </div>
            </div>
          ...
          {/* Download Options */}
          <div className="w-80 border-l bg-background-light p-6">
            <h3 className="text-lg font-semibold text-text-primary-light mb-4">Download Options</h3>
              ...
              {availableFormats.map(format => {
                ...
                return (
                  <button
                    ...
                    className="w-full p-4 border border-support-light rounded-lg hover:bg-support-light transition-colors flex items-center justify-between disabled:opacity-50 disabled:cursor-not-allowed"
                  >
