...
export const UserOnboarding: React.FC<UserOnboardingProps> = ({
  ...
  const steps: OnboardingStep[] = [
    ...
    {
      id: 'assessment',
      title: 'Start with CMMC Assessment',
    ...
    },
    {
      ...
      description: 'Use the dashboard to track CMMC control implementation progress and certification readiness.',
      icon: BarChart3,
      action: {
        label: 'View CMMC Dashboard',
        onClick: () => navigate('/dashboard')
      }
    },
    {
      id: 'evidence',
      title: 'Collect CMMC Evidence',
      description: 'Systematically collect and manage compliance evidence for C3PAO assessment and audit documentation.',
      icon: FileText,
      action: {
        label: 'Manage CMMC Evidence',
