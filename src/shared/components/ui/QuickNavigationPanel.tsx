...
import { Shield, Target, FileText, ChartBar as BarChart3, Users, Calendar, CircleCheck as CheckCircle, Clock, TriangleAlert as AlertTriangle, Award, Activity, Zap } from 'lucide-react';
...
export const QuickNavigationPanel: React.FC<QuickNavigationPanelProps> = ({
  ...
  const quickLinks = [
    ...
    },
    {
      ...
      description: 'Follow structured compliance roadmap',
