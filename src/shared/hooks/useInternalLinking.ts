...
export const useInternalLinking = () => {
    ...
    '/dashboard': [
      {
        ...
        description: 'Begin comprehensive CMMC Level 1 evaluation',
        href: '/assessment-intro',
        category: 'next-step',
        priority: 'high',
        anchorText: ['start cmmc assessment', 'new evaluation', 'begin CMMC Level 1 assessment']
      },
      {
        title: 'CMMC Implementation Workflow',
        description: 'Follow structured CMMC Level 1 implementation roadmap',
  ...
  const getBreadcrumbsForPath = (pathname: string) => {
    ...
    const pathLabels: Record<string, string> = {
      ...
      'compliance-workflow': 'Implementation Workflow',
