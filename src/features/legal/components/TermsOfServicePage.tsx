        ...
        <div className="bg-surface-light dark:bg-surface-dark border border-support-light dark:border-support-dark rounded-xl shadow-lg p-6 sm:p-8 space-y-6">
          ...
          <section>
            <p className="text-text-secondary-light dark:text-text-secondary-dark leading-relaxed mb-3">
              By accessing or using any {companyName} ("ERMITS," "we," "our," or "us") products, platforms, or services (collectively, the "Services"), you ("User," "you," or "your") agree to be bound by these Master Terms of Service ("Terms"). If you do not agree to these Terms, do not use our Services.
            </p>
          </section>
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-text-primary-light dark:text-text-primary-dark mb-2 mt-4">
              1.4.2 Data Sovereignty Options
            </h3>
            <p className="text-text-secondary-light dark:text-text-secondary-dark leading-relaxed mb-3">
            ...
            <p className="text-text-secondary-light dark:text-text-secondary-dark leading-relaxed mb-2">
              <strong>Local Storage Options:</strong>
            </p>
            ...
            <p className="text-text-secondary-light dark:text-text-secondary-dark leading-relaxed mb-2">
              <strong>Cloud Storage Options:</strong>
            </p>
            <ul className="list-disc list-inside space-y-2 text-text-secondary-light dark:text-text-secondary-dark ml-4 mb-4">
            ...
            <h3 className="text-xl font-semibold text-text-primary-light dark:text-text-primary-dark mb-2 mt-4">
              1.4.4 Zero-Knowledge Principles
            </h3>
            <p className="text-text-secondary-light dark:text-text-secondary-dark leading-relaxed mb-3">
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-text-primary-light dark:text-text-primary-dark mb-2 mt-4">
              1.6.2 User Data License to ERMITS
            </h3>
            <p className="text-text-secondary-light dark:text-text-secondary-dark leading-relaxed mb-3">
              You grant ERMITS a limited license to your User Data solely to the extent necessary to:
            </p>
            <ul className="list-disc list-inside space-y-2 text-text-secondary-light dark:text-text-secondary-dark ml-4 mb-3">
            ...
            <h3 className="text-xl font-semibold text-text-primary-light dark:text-text-primary-dark mb-2 mt-4">
              1.6.3 User Data Responsibilities
            </h3>
            <p className="text-text-secondary-light dark:text-text-secondary-dark leading-relaxed mb-3">
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-text-primary-light dark:text-text-primary-dark mb-2 mt-4">
              1.7.1 ERMITS Intellectual Property
            </h3>
            <p className="text-text-secondary-light dark:text-text-secondary-dark leading-relaxed mb-3">
            ...
            <h3 className="text-xl font-semibold text-text-primary-light dark:text-text-primary-dark mb-2 mt-4">
              1.7.3 User-Generated Reports and Outputs
            </h3>
            <p className="text-text-secondary-light dark:text-text-secondary-dark leading-relaxed mb-3">
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-text-primary-light dark:text-text-primary-dark mb-2 mt-4">
              1.8.3 Data Sharing with Third Parties
            </h3>
            <p className="text-text-secondary-light dark:text-text-secondary-dark leading-relaxed mb-3">
          ...
          {/* Federal Contractor Specific Terms */}
          <section>
            <h2 className="text-2xl font-semibold text-text-primary-light dark:text-text-primary-dark mb-3">
            ...
            <h3 className="text-xl font-semibold text-text-primary-light dark:text-text-primary-dark mb-2 mt-4">
              1.10.2 Compliance Representations
            </h3>
            <p className="text-text-secondary-light dark:text-text-secondary-dark leading-relaxed mb-3">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-text-secondary-light dark:text-text-secondary-dark ml-4 mb-3">
              ...
              <li>Contacting ERMITS support at {contactEmail}</li>
              <li>Following product-specific cancellation procedures</li>
            </ul>

            <h3 className="text-xl font-semibold text-text-primary-light dark:text-text-primary-dark mb-2 mt-4">
              1.13.3 Termination by ERMITS
            </h3>
            <p className="text-text-secondary-light dark:text-text-secondary-dark leading-relaxed mb-3">
            ...
            <h3 className="text-xl font-semibold text-text-primary-light dark:text-text-primary-dark mb-2 mt-4">
              1.13.5 Data Retention After Termination
            </h3>
            <p className="text-text-secondary-light dark:text-text-secondary-dark leading-relaxed mb-3">
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-text-primary-light dark:text-text-primary-dark mb-2 mt-4">
              1.14.2 Disclaimer of Warranties
            </h3>
            <p className="text-text-secondary-light dark:text-text-secondary-dark leading-relaxed mb-3">
            ...
            <h3 className="text-xl font-semibold text-text-primary-light dark:text-text-primary-dark mb-2 mt-4">
              1.14.5 Privacy-First Architecture Limitations
            </h3>
            <p className="text-text-secondary-light dark:text-text-secondary-dark leading-relaxed mb-3">
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-text-primary-light dark:text-text-primary-dark mb-2 mt-4">
              1.15.1 Exclusion of Consequential Damages
            </h3>
            <p className="text-text-secondary-light dark:text-text-secondary-dark leading-relaxed mb-3">
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-text-primary-light dark:text-text-primary-dark mb-2 mt-4">
              1.16.4 Indemnification Process
            </h3>
            <p className="text-text-secondary-light dark:text-text-secondary-dark leading-relaxed mb-3">
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-text-primary-light dark:text-text-primary-dark mb-2 mt-4">
              1.18.4 Beta Product Exclusions
            </h3>
            <p className="text-text-secondary-light dark:text-text-secondary-dark leading-relaxed">
          ...
          <section>
            ...
            <p className="text-text-secondary-light dark:text-text-secondary-dark leading-relaxed mb-3">
              <strong>Class Action Waiver:</strong> YOU AND ERMITS AGREE THAT DISPUTES MUST BE BROUGHT ON AN INDIVIDUAL BASIS ONLY, AND NOT AS A PLAINTIFF OR CLASS MEMBER IN ANY PURPORTED CLASS, REPRESENTATIVE, OR COLLECTIVE PROCEEDING. CLASS ARBITRATIONS, CLASS ACTIONS, AND REPRESENTATIVE ACTIONS ARE NOT PERMITTED.
            </p>

            <h3 className="text-xl font-semibold text-text-primary-light dark:text-text-primary-dark mb-2 mt-4">
              1.20.4 Opt-Out of Arbitration
            </h3>
            <p className="text-text-secondary-light dark:text-text-secondary-dark leading-relaxed">
              You may opt out of the arbitration provision by sending written notice to ERMITS at {contactEmail} within 30 days of first accepting these Terms. The notice must include your name, address, and a clear statement that you wish to opt out of arbitration. If you opt out, disputes will be resolved in court pursuant to Section 1.20.2.
            </p>
          </section>
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-text-primary-light dark:text-text-primary-dark mb-2 mt-4">
              1.21.5 No Third-Party Beneficiaries
            </h3>
            <p className="text-text-secondary-light dark:text-text-secondary-dark leading-relaxed mb-3">
            ...
            <ul className="list-disc list-inside space-y-2 text-text-secondary-light dark:text-text-secondary-dark ml-4 mb-3">
              ...
              <li>When sent by email to {contactEmail} (for notices to ERMITS)</li>
              <li>When sent by email to your registered email address (for notices to you)</li>
            </ul>

            <h3 className="text-xl font-semibold text-text-primary-light dark:text-text-primary-dark mb-2 mt-4">
              1.21.7 Export Controls
            </h3>
            <p className="text-text-secondary-light dark:text-text-secondary-dark leading-relaxed mb-3">
            ...
            <h3 className="text-xl font-semibold text-text-primary-light dark:text-text-primary-dark mb-2 mt-4">
              1.21.9 Independent Contractors
            </h3>
            <p className="text-text-secondary-light dark:text-text-secondary-dark leading-relaxed mb-3">
          ...
          <section>
            ...
            <p className="text-text-secondary-light dark:text-text-secondary-dark leading-relaxed">
              For technical support, privacy, compliance, and legal inquiries, please contact us at{' '}
