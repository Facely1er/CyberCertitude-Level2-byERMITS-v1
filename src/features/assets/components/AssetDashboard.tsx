...
import { 
  ...
  CheckSquare, ArrowRight, Map, ChevronLeft, Activity
} from 'lucide-react';
...
export const AssetDashboard: React.FC<AssetDashboardProps> = ({
  ...
  const metrics: AssetMetrics = React.useMemo(() => {
    ...
    const riskDistribution = assets.reduce((acc, asset) => {
      const risk = asset.riskAssessment?.overallRisk || 'Unknown';
    ...
    const maintenanceOverdue = assets.filter(asset => 
      asset.lifecycle?.maintenanceSchedule?.nextMaintenance && 
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
             ...
             >
               ...
               <div>
                 ...
                 <div className="text-sm text-gray-600 dark:text-gray-300">Complete structured roadmap</div>
               </div>
             </Link>
