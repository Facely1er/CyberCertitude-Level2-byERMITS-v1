...
import { 
  ...
  CheckCircle, Target, Award, Star, BookOpen, AlertTriangle,
  Eye, EyeOff, Download, Upload, BarChart3, Calendar, Shield,
  Info, HelpCircle, Lightbulb, FileCheck, MessageCircle, Tag,
  Activity, Zap, RefreshCw, Plus, Edit3, ArrowRight, Building,
  Check, Pause, Calendar as CalendarIcon, X, XCircle
} from 'lucide-react';
...
interface CMMCLevel1EnhancedAssessmentViewProps {
...
export const CMMCLevel1EnhancedAssessmentView: React.FC<CMMCLevel1EnhancedAssessmentViewProps> = ({
  assessment,
  framework,
  onSave,
  onComplete,
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg border border-gray-200 dark:border-gray-700">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center space-x-3 text-sm text-gray-600 dark:text-gray-300">
                <span className="bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300 px-3 py-1 rounded-full font-medium">
                  Practice {currentQuestionIndex + 1} of {currentCategory?.questions.length || 0}
                </span>
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-green-500 focus:border-transparent resize-none"
              rows={4}
            ...
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900 dark:text-white">
                  CMMC 2.0 Level 1 Assessment - Basic Cyber Hygiene
                </h1>
                <p className="text-gray-600 dark:text-gray-300">
                  Self-Assessment • FCI Protection • 17 Practices
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 mb-8 p-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Domain: {currentSection?.name} • Practice: {currentCategory?.name}
            </p>
          </div>
...
export default CMMCLevel1EnhancedAssessmentView;