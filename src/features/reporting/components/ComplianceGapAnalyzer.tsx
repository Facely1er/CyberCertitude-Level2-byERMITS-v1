      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-12 text-center">
          <div className="flex items-center justify-center mb-6">
            <div className="p-4 bg-gradient-brand-subtle dark:bg-gradient-dark-brand rounded-2xl">
              <Target className="w-12 h-12 text-primary-gold dark:text-dark-primary" />
            </div>
          </div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
            Start Your SP 800-171 Assessment
          </h2>
          <p className="text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
            Complete a SP 800-171 assessment to generate comprehensive gap analysis and implementation recommendations for CMMC compliance.
          </p>
          <button
            onClick={onStartAssessment}
            className="bg-gradient-brand text-white px-8 py-4 rounded-xl hover:bg-gradient-primary transition-all duration-200 inline-flex items-center space-x-3 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
          >
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900 dark:text-white">
                  SP 800-171 Gap Analysis
                </h1>
                <p className="text-gray-600 dark:text-gray-300">
                  Comprehensive analysis of CMMC implementation gaps and recommendations
                </p>
              </div>
            </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-6 mb-8">
        <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-6">
          SP 800-171 Control Gap Analysis
        </h3>
        ...
        <div className="h-80">
          <BarChart
            ...
            height={320}
            title="SP 800-171 Implementation Gaps by Control Family"
          />
        </div>
      </div>
      ...
      <div className="space-y-6">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white">
          Detailed SP 800-171 Gap Analysis & Recommendations
        </h2>
      ...
      <div className="bg-gradient-brand-subtle dark:bg-gradient-dark-brand rounded-xl p-8 mt-8 border border-primary-gold/20 dark:border-dark-primary/30">
        <h3 className="text-2xl font-bold text-brand-neutral dark:text-dark-primary mb-4">
          Implementation Summary
        </h3>
        ...
        <div className="mt-6 pt-6 border-t border-blue-200 dark:border-blue-700">
          <p className="text-blue-800 dark:text-blue-200 mb-4">
            <strong>Next Steps:</strong> Prioritize critical and high-priority gaps, develop implementation plans for each SP 800-171 control family, 
            and begin systematic evidence collection to support CMMC compliance.
          </p>
          <button
