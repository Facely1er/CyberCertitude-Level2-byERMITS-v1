            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Manage and monitor SP 800-171 security controls implementation for CMMC compliance
                </p>
              </div>
            </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-green-600 dark:text-green-400">{statistics?.implemented || 0}</p>
              </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-blue-600 dark:text-blue-400">{statistics?.partiallyImplemented || 0}</p>
              </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-red-600 dark:text-red-400">{statistics?.notImplemented || 0}</p>
              </div>
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            >
              ...
              {controls.map(control => control.owner).filter((owner, index, arr) => arr.indexOf(owner) === index).map(owner => (
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
        <div className="p-6 border-b border-gray-200 dark:border-gray-700">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white">
            SP 800-171 Security Controls ({filteredControls.length})
          </h2>
        </div>
