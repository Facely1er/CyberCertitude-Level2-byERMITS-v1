...
import { Target, Plus, CreditCard as Edit, Trash2, Save, Download, Search, ListFilter as Filter, CircleCheck as CheckCircle, TriangleAlert as AlertTriangle, Circle as XCircle } from 'lucide-react';
...
const SecurityControlMapper: React.FC<SecurityControlMapperProps> = ({
  onSave,
  onExport
}) => {
