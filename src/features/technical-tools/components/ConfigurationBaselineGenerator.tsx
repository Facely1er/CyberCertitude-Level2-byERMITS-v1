...
import { Settings, Plus, Edit, Trash2, Save, Download, CheckCircle, AlertTriangle, Shield } from 'lucide-react';
...
export const ConfigurationBaselineGenerator: React.FC<ConfigurationBaselineGeneratorProps> = ({
  onSave,
  onExport
}) => {
