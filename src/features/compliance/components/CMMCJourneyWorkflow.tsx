            ...
            >
              <div className="flex items-center gap-3 mb-3">
                <div className={`p-2 rounded-lg ${
                  phase.status === 'completed' ? 'bg-success-100 text-success-600' :
                  phase.status === 'in-progress' ? 'bg-primary-100 text-primary-600' :
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-medium text-text-primary-light dark:text-text-primary-dark">{phase.progress}%</span>
                </div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-3">
                      <div className="flex items-center justify-between text-sm mb-1">
                        <span className="text-text-secondary-light dark:text-text-secondary-dark">Progress</span>
                        <span className="font-medium text-text-primary-light dark:text-text-primary-dark">{step.progress}%</span>
                      </div>
                      <div className="w-full bg-support-light dark:bg-surface-dark rounded-full h-2">
                        <div 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-6">
              <div className="bg-background-light dark:bg-surface-dark rounded-lg p-4">
                <h4 className="font-semibold text-text-primary-light dark:text-text-primary-dark mb-3">Step Information</h4>
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-text-primary-light dark:text-text-primary-dark">{step.estimatedTime}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-text-secondary-light dark:text-text-secondary-dark">Progress:</span>
                    <span className="text-text-primary-light dark:text-text-primary-dark">{step.progress}%</span>
                  </div>
                </div>
              </div>
              ...
              {/* Progress Control */}
              <div className="bg-background-light dark:bg-surface-dark rounded-lg p-4">
                <h4 className="font-semibold text-text-primary-light dark:text-text-primary-dark mb-3">Update Progress</h4>
                <div className="space-y-3">
                  <div>
                    <label 
                      htmlFor={`progress-${phase.id}-${step.id}`}
                      className="block text-sm font-medium text-text-primary-light dark:text-text-secondary-dark mb-2"
                    >
                    ...
                    <input
                      ...
                      className="w-full h-2 bg-support-light dark:bg-primary-600 rounded-lg appearance-none cursor-pointer"
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="flex-1 px-3 py-2 bg-success-600 text-white rounded-lg hover:bg-success-700 transition-colors text-sm"
                    >
                      Complete
                    </button>
                  </div>
            ...
            <div className="space-y-6">
              {/* Tools */}
              <div className="bg-background-light dark:bg-surface-dark rounded-lg p-4">
                <h4 className="font-semibold text-text-primary-light dark:text-text-primary-dark mb-3">Available Tools</h4>
                <div className="space-y-2">
                  {step.tools.map((tool, index) => (
                    <button
                      key={index}
                      onClick={() => handleToolClick(tool)}
                      className="w-full text-left p-2 bg-surface-light dark:bg-surface-dark rounded-lg hover:bg-background-light dark:hover:bg-surface-dark transition-colors flex items-center gap-2"
                    >
                      <Settings className="w-4 h-4 text-primary-500" />
                      <span className="text-sm text-text-primary-light dark:text-text-primary-dark">{tool}</span>
                      <ArrowRight className="w-4 h-4 text-text-muted-dark ml-auto" />
                    </button>
                  ))}
                </div>
              </div>
              ...
              {/* Resources */}
              <div className="bg-background-light dark:bg-surface-dark rounded-lg p-4">
                <h4 className="font-semibold text-text-primary-light dark:text-text-primary-dark mb-3">Resources</h4>
                <div className="space-y-2">
                  {step.resources.map((resource, index) => (
                    ...
                    >
                      ...
                      <span className="text-sm text-text-primary-light dark:text-text-primary-dark">{resource}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              {/* Deliverables */}
              <div className="bg-background-light dark:bg-surface-dark rounded-lg p-4">
                <h4 className="font-semibold text-text-primary-light dark:text-text-primary-dark mb-3">Deliverables</h4>
                <div className="space-y-2">
                  {step.deliverables.map((deliverable, index) => (
                    ...
                    >
                      ...
                      <span className="text-sm text-text-primary-light dark:text-text-primary-dark">{deliverable}</span>
                    </div>
                  ))}
                </div>
              </div>
