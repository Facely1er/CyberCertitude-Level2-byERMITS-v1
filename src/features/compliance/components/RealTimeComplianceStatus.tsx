...
import { 
  ...
  Target, RefreshCw, Activity, Zap, Calendar, FileText
} from 'lucide-react';
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300">
                SP 800-171 Implementation Progress
              </p>
            </div>
          </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Link
            ...
            className="flex items-center space-x-3 p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors text-left group"
          >
            <Activity className="w-6 h-6 text-purple-600 dark:text-purple-400" />
            <div>
              <div className="font-medium text-gray-900 dark:text-white">Implementation Workflow</div>
              <div className="text-sm text-gray-600 dark:text-gray-300">Follow structured roadmap</div>
            </div>
          </Link>
