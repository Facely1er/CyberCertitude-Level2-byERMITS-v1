...
import { FileText, Upload, Download, Search, Filter, Plus, Edit, Trash2, CheckCircle, XCircle, Eye, Shield, Users, Settings, AlertTriangle } from 'lucide-react';
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg mb-6">
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {/* Access Control */}
            <div className="bg-gradient-brand-subtle dark:bg-gradient-dark-brand rounded-lg p-4 border border-primary-gold/20 dark:border-dark-primary/30">
