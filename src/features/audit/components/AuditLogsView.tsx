...
import { ArrowLeft, Search, Filter, Download, RefreshCw, Calendar, User, Shield, AlertTriangle, CheckCircle, Clock, Eye } from 'lucide-react';
...
export const AuditLogsView: React.FC<AuditLogsViewProps> = ({ onBack, addNotification }) => {
